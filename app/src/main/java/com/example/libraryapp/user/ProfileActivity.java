...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        userRef.orderByChild("userMail").equalTo(owner_email).addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                if (dataSnapshot.getValue() != null) {
                    profile_name.setText(dataSnapshot.child("userName").getValue().toString());
                    profile_email.setText(dataSnapshot.child("userMail").getValue().toString());
//                    profile_location.setText(dataSnapshot.child("location").getValue().toString());
                }
            }
